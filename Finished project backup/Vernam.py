...
#A function that takes a key and either shortens the key to the size of the plaintext or lengthens the key if it is too short
...
#A function that encrypts the file using the vernam encryption algorithm
...
#A function that decrypts the file from ciphertext to plaintext    
